  ...
  "Buttons": [
    {
      ...
      size: "0.45kb",
      preview: React.createElement(PrimaryButton, { icon: Sparkles }, "Primary Button"),
    ...
    },
    {
      ...
      size: "0.45kb",
      preview: React.createElement(PrimaryButton, { icon: Sparkles }, "Large Button"),
  ...
  "Cards": [
    {
      ...
      size: "0.35kb",
      preview: React.createElement(Card, { title: "Card Title", subtitle: "Subtitle" }, "Card content"),
