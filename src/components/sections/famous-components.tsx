...
const COMPONENTS = [
  { name: "Glass Morphism Card", category: "UI", size: "2.4kb", description: "Frosted glass effect with sleek borders." },
  { name: "Infinite Scroll List", category: "Logic", size: "4.1kb", description: "Smooth, virtualized list for heavy data." },
  { name: "Radial Context Menu", category: "UX", size: "3.2kb", description: "Modern circular menu for quick actions." },
]
            ...
            >
              ...
              <div className="relative aspect-video w-full overflow-hidden rounded-lg  flex items-center justify-center mb-4">
                 <div className="absolute inset-0 opacity-[0.05] dark:opacity-[0.1]" 
                      style={{backgroundImage: 'radial-gradient(circle at 2px 2px, var(--foreground) 1px, transparent 0)', backgroundSize: '16px 16px'}} />
