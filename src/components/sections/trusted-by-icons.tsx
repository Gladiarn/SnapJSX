...
export const NextJsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
...
export const TailwindIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" width="40" height="40" {...props}>
    <path d="M12 2C9.25 2 7 4.25 7 7c0 2.75 2.25 5 5 5h2.5c2.75 0 5 2.25 5 5s-2.25 5-5 5-5-2.25-5-5H7c0 2.75 2.25 5 5 5s5-2.25 5-5V7c0-2.75-2.25-5-5-5z" fill="#38BDF8" />
  </svg>
);

export const ReactIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="#61DAFB" strokeWidth="2" {...props}>
    <circle cx="12" cy="12" r="2.5" />
    <path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z" opacity="0.5" transform="rotate(60 12 12)" />
    <path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z" opacity="0.5" transform="rotate(120 12 12)" />
  </svg>
);
