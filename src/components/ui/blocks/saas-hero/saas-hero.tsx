...
/**
 * SaaS Hero Block - A high-converting hero section for modern SaaS landing pages.
 */
    ...
    <section className="relative overflow-hidden bg-background pt-24 pb-16 md:pt-32 md:pb-24">
      ...
      <div className="container relative mx-auto px-4">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
          ...
          >
            Build your <span className="text-primary">Next Big Idea</span>{" "}
            faster.
          </motion.h1>
          ...
          >
            High-performance, zero-dependency React components and sections
            designed for speed and scalability. Copy, paste, and ship your
          ...
          >
            ...
            <button
              type="button"
              className="px-8 py-4 rounded-xl font-bold text-base hover:bg-muted transition-colors"
            >
              View Showcase
            </button>
          </motion.div>
