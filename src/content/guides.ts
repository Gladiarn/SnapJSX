    ...
    sections: [
      {
        title: "Semantic HTML",
        content:
          "We strictly use semantic HTML elements (button, nav, aside, main) to ensure built-in accessibility. We avoid 'div-soup' and ensure every interactive element has a clear role.",
      },
      {
        title: "Keyboard Navigation",
        content:
          "All interactive components are tested for keyboard accessibility. We ensure focus rings are visible and logical tab order is maintained.",
      },
    ],
  },
  {
